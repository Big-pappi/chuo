...
# JWT Configuration
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': config('JWT_ACCESS_TOKEN_LIFETIME', default=15, cast=int),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'CHUO University Management API',
    'DESCRIPTION': 'API documentation for CHUO University Management System',
    'VERSION': '1.0.0',
